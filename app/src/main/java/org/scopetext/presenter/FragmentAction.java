 ...
 * Created by john.qualls on 12/2/2016.
...
public interface FragmentAction {
     ...
     */
    public void mainActivityRefresh(AppCompatActivity activity);

    /**
     * Adds a new fragment to a View container. Handles the interaction with the FragmentManager
    ...
    //TODO Look at API to find out if replace is desired.
}
