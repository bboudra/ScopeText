...
CREATE TABLE Main.CONTACT_ASSOCIATION (
                    ...
                    CONTACT_ID INTEGER,
                    FOREIGN KEY(SCOPETEXT_ID) REFERENCES SCOPETEXT(_ID) ON DELETE CASCADE,
                    FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE
                  );          

-- SELECTS
SELECT ST.NAME, M.TYPE, M.REG_EXP, R.ACTION_APP, R.EXTERNAL_APP, ST.IN_USE
FROM SCOPETEXT ST LEFT JOIN MESSAGE M ON ST.MESSAGE_ID = M.MESSAGE_ID
LEFT JOIN RESPONSE R ON ST.RESPONSE_ID = R.RESPONSE_ID;
