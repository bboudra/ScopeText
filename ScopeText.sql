...
FROM MAIN.SCOPETEXT ST
LEFT JOIN MAIN.CONTACT_ASSOCIATION CA ON ST.SCOPETEXT_ID = CA.SCOPETEXT_ID
LEFT JOIN MAIN.CONTACT C ON C.CONTACT_ID = CA.CONTACT_ID
ORDER BY ST.SCOPETEXT_ID;

PRAGMA foreign_keys = ON;

INSERT INTO SCOPETEXT (NAME, IN_USE) VALUES ('Name1', 'Y');

INSERT INTO CONTACT (NAME) 
VALUES ('Contact1');

INSERT INTO CONTACT_ASSOCIATION (CONTACT_ASSOC_ID, SCOPETEXT_ID, CONTACT_ID)
VALUES (0, 0, 0);

*/

SELECT * FROM SCOPETEXT;